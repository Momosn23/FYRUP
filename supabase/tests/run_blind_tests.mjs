...
const includeShots = process.argv.includes('--shots');
try {
  ...
  for (const filename of [...(includeShots ? ['call_my_shot.sql'] : []), 'blind_workouts.sql', 'weekly_flames.sql', 'workout_plans.sql', 'activity_pause.sql', 'daily_steps.sql']) {
