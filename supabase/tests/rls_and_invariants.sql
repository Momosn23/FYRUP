...
select has_policy('storage','objects','avatars_insert_own','avatar owner insert policy');
select has_policy('storage','objects','avatars_update_own','avatar owner update policy');
select has_policy('storage','objects','avatars_delete_own','avatar owner delete policy');
select has_policy('storage','objects','avatars_read_self_or_friends','avatar private read policy');
