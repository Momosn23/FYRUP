...
**Aktueller Stand für LIVEUI/TIMER:** Die Live-Anzeige besitzt eine echte interaktive Satzpausenaktion statt des früheren reinen Öffnen-Links. Im aktuellen lokalen Folgequellstand ergänzt „Satz eintragen“ für reguläre Gym-Workouts einen geschützten Direkteinstieg in den ersten offenen Satz der aktuellen Übung; Gewicht, Wiederholungen und Übungsbewertung werden erst in der geöffneten App bearbeitet und nie auf dem Sperrbildschirm gezeigt. Zusätzlich ist ein kleines Homescreen-Widget mit laufender Zeit und Start/Beenden der Satzpause eingebettet. App, Widget und Live-Anzeige verwenden im Produktionspfad denselben privaten App-Group-Zustand; bestehende lokale Pauseneinstellungen werden übernommen. Bei tatsächlichen Änderungen wird das Homescreen-Widget sofort, bei unverändertem Stand nicht unnötig neu geladen. Die freiwillige Ablauf-Mitteilung wird auch bei Start aus dem Widget berücksichtigt. `group.app.fyrup.shared` ist bei Apple registriert, beiden App-Kennungen zugeordnet und beide App-Store-Profile wurden am 05.09.2026 erneuert. Die Profile sind in Codemagic gespeichert und im Workflow eingetragen. Build 45 und der signierte Build 46 kompilieren App/Erweiterung und bestehen alle nativen Tests; Build 46 prüft die Profile, baut die IPA und lädt sie ohne Fehler zu Apple. Der neue Satz-Direkteinstieg sowie die echte Sperrbildschirm-/Dynamic-Island-/Widget-Bedienung auf dem iPhone sind noch nicht nativ beziehungsweise auf dem Gerät abgenommen.
...
- [x] LIVEUI-05 Sperrbildschirm und Widget zeigen keine Gewichte oder Wiederholungen. Der Name der aktuellen Übung und der reine Satzfortschritt erscheinen nur während eines bewusst gestarteten regulären Gym-Workouts; sonst bleiben auch diese Angaben verborgen.
- [ ] LIVEUI-06 Bei einem regulären Gym-Workout zeigt die Live-Aktivität die aktuelle Übung und den Satzfortschritt sowie „Satz eintragen“. Der geschützte Link öffnet ausschließlich die bestätigte eigene LIVE-Session und dort den ersten offenen Satz für Gewicht, Wiederholungen und private Übungsbewertung. Gewichte und Wiederholungen bleiben vom Sperrbildschirm ausgeschlossen. *(Lokal umgesetzt; native Build-, Dynamic-Island- und iPhone-Abnahme offen.)*
