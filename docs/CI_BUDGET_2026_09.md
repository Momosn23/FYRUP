...
Konservativ verbraucht aus abgeschlossenen Läufen: **4,08 USD** (bisher konservativ 2,61 USD plus 1,47 USD für #68). **Kein Lauf aktiv, keine Reserve, Restbudget 5,92 USD.** Dies ist eine konservative Kostenschätzung, keine abschließende Anbieterrechnung und kein Kontoguthaben.
