...
Aktueller Folgelauf: Codemagic 49 (`4503d12`) stoppte an einer uneindeutigen Rückgabetyp-Ableitung im neuen Demo-Übungsverlauf. Build 50 (`426b399`) kam darüber hinaus und stoppte an zwei Einstellungsüberschriften, die versehentlich einen dateiprivaten Darstellungshelfer aus „Freunde“ verwendeten. Build 51 (`026c39b`) übersetzte danach die App und die neuen Einstellungsziele; er stoppte erst beim Übersetzen eines neuen Repository-Tests, weil ein asynchroner Aufruf direkt in `XCTUnwrap` stand. Der Folgequellstand wertet den asynchronen Aufruf vor der Testprüfung aus. Eine vollständige neue native Abnahme ist noch offen.
