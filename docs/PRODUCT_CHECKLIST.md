...
**Aktueller nativer Prüfpunkt:** [QA #70 auf `704674e`](REFERENCE_QA_70.md) **FAIL nach 12m22s: 539/540 Unit-Tests und 12/12 Referenz-Bedientests PASS**. Das vom Nutzer gelieferte ZIP ist vollständig ausgewertet, alle 33 echten PNGs einzeln geprüft. Alle zwölf neuen Netzwerkfälle bestanden; einziger Testfehler ist die Suche Rücken/Bankdrücken, im Folgecode `8f4d655` korrigiert. Aus den Bildern zusätzlich Filter-/Kartenanordnung und falschen Wochenbeginn im Profil korrigiert; Wochenrand-/Sommerzeit- und UI-Regressionstests ergänzt. Diese Folgekorrekturen sind noch nicht nativ bestätigt. Kein Apple-Upload; Kosten/aktiver Lauf im [Budgetlaufbuch](CI_BUDGET_2026_09.md). Keine Gesamtfreigabe; ältere Statusangaben unten sind historische Zwischenstände.
