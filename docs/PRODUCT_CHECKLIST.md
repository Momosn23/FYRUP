...
Aktualisierung ab12:50 CEST: Build31 (`7910f6c`) hat alle382 Einzeltests bestanden, die UI-Suite läuft noch. Sprachüberarbeitung und private Supplement-Liste sind integriert;960 lokale Datenbank- und57 Versand-/Terminologieprüfungen bestehen. Backend001–013 ist ausgerollt und unabhängig geprüft. Der neue Push-Dienst ist bereitgestellt, frische Laufzeitprüfung folgt. Noch kein neuer signierter TestFlight-Stand. Build29 (`073b933`) bleibt der letzte vollständig visuell geprüfte Muskelgrafik-Stand (365 Einzeltests,26 UI-Abläufe). Die nachfolgenden älteren Build-Angaben bleiben als Historie erhalten.
