...
Aktueller Folgelauf: Codemagic 53 (`6842550`) übersetzte App und Testziele vollständig und führte 37 Bedienabläufe aus; 36 bestanden. Die neue private „Zuletzt/Bestwert“-Karte bestand damit ihren vollständigen Bedienablauf. Einziger Fehler blieb nach dem Abmelden im Willkommensablauf: Die Kennung des umgebenden Bildbereichs verdeckte für die iOS-Bedienhilfe die eigene Kennung des E-Mail-Knopfs. Der Folgequellstand entfernt diese überflüssige Elternkennung und prüft den Bildbereich stattdessen über seinen sichtbaren Titel. Eine vollständige neue native Abnahme ist noch offen. Migration 016 für den privaten Übungsverlauf ist produktiv angewendet und unabhängig geprüft: Funktion vorhanden, Ausführung für `authenticated` erlaubt sowie für `anon` und `public` gesperrt.
