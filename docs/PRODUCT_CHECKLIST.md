...
Aktueller Folgelauf: Codemagic 52 (`4c9b7b4`) übersetzte App und Testziele vollständig und führte 37 Bedienabläufe aus; 35 bestanden. Zwei eng eingegrenzte Bedienprüfungen blieben rot: Nach dem Abmelden war der E-Mail-Einstieg im neuen Willkommensablauf noch nicht zuverlässig bedienbar, und die sichtbare „Zuletzt/Bestwert“-Karte des privaten Übungsverlaufs war für VoiceOver nicht als zusammengehöriger Inhalt ausgezeichnet. Beide Ursachen sind im Folgequellstand korrigiert; eine vollständige neue native Abnahme ist noch offen. Migration 016 für den privaten Übungsverlauf ist inzwischen produktiv angewendet und unabhängig geprüft: Funktion vorhanden, Ausführung für `authenticated` erlaubt sowie für `anon` und `public` gesperrt.
