...
Aktueller Arbeitskopien-Nachtrag vom 08.09.2026: [E-Mail-Anmeldung/Recovery, Supplement-Mengen und Veröffentlichungsvoraussetzungen](REFERENCE_AUTH_SUPPLEMENTS_2026_09_08.md). Sieben Auth-Einzeltests und sieben Referenz-Bedientests vorbereitet, noch nicht nativ ausgeführt. Supabase-Rückkehradresse produktiv auf exakt `fyrup://auth-callback` eingerichtet. SMTP nur vorbereitet: freigegebener Kundenservice-Absender, aber noch keine verifizierten Ausgangsserver-Zugangsdaten. Separater FYRUP-Datenschutzentwurf angelegt, nicht veröffentlicht. Migrationen 017–019 weiterhin nur lokal geprüft. Lokaler Gesamt-Preflight am 08.09. um 14:04 UTC: **21/21 PASS**, kein Swift-/iPhone-Nachweis und kein weiterer kostenpflichtiger Lauf.
...
**Aktueller Folgeblock:** [Lokale Einrichtung/Übersichten vom 08.09.](REFERENCE_LOCAL_SETUP_2026_09_08.md): benannte Wiederaufnahme, getrennte optionale Ziel-/Rechteseiten, editierbare Zusammenfassung und kompaktere Heute-/Ernährungsübersicht. Migration 018 nur lokal geprüft; kein neuer kostenpflichtiger Build/Upload. Der jüngste native Nachweis ist #67 auf `e39caf6` (495 Unit-Tests, 3 Referenz-UI-Tests), **nicht** die danach geänderte Arbeitskopie. Die vollständige neue Checkliste bleibt offen.
