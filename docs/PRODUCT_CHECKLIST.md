...
Aktueller Folgelauf: Codemagic 49 (`4503d12`) bestand sämtliche lokalen Vorprüfungen und stoppte nach 2 Minuten 23 Sekunden beim nativen Übersetzen an einer uneindeutigen Rückgabetyp-Ableitung im neuen Demo-Übungsverlauf. Build 50 (`426b399`) kam über diese Stelle hinaus und stoppte nach 1 Minute 56 Sekunden an zwei neuen Einstellungsüberschriften, die versehentlich einen dateiprivaten Darstellungshelfer aus „Freunde“ verwendeten. Der Folgequellstand formatiert beide Überschriften direkt; die lokale Gesamtprüfung wird vor dem nächsten nativen Lauf wiederholt. Eine neue native Abnahme ist noch offen.
