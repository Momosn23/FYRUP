...
**App-Prüfung am 23.09.2026:** Apple hat Build 17 erneut ausschließlich wegen der auf der weißen Heute-Wetterkarte nicht sichtbaren WeatherKit-Quellenangabe abgelehnt. Ursache und Korrektur sind in [APP_REVIEW_WEATHERKIT_2026_09_23.md](APP_REVIEW_WEATHERKIT_2026_09_23.md) dokumentiert. Die App verwendet nun die passende helle Oberflächenvariante der Apple-Weather-Marke, einen dauerhaft sichtbaren Link „Datenquellen“ und einen „ Weather“-Fallback. Der einmalige signierte Paketlauf aus `facc598` ist als Build 18 ohne Uploadfehler bei Apple verarbeitet und intern verfügbar. Echtes iPhone-Video mit sichtbarer Kennzeichnung sowie Ersetzen von Build 17 und erneute Übermittlung sind noch offen.

**Aktueller Stand am 09.09.2026:** [QA #71 auf `b538d05`](REFERENCE_QA_71.md) **544/544 Unit-Tests und 12/12 Referenz-Bedientests PASS**, vollständiges Nutzer-ZIP und alle 33 Einzelbilder geprüft. Suche, Filterdarstellung und Montag-Woche im Profil bestätigt. Der unveränderte App-Code ist inzwischen als [TestFlight 1.0.0 (16)](TESTFLIGHT_16_2026_09_09.md) gebaut, signiert, ohne Uploadfehler von Apple angenommen, verarbeitet und **FYRUP Intern** zugeordnet. Fertige IPA auf Produktionskonfiguration und tatsächliche WeatherKit-/HealthKit-/App-Group-Signierung geprüft. Paketlauf 4m35s, keine erneute vollständige Testsuite; kein aktiver/automatischer Folgelauf. Konservativ **9,52 USD von 10 USD** verbraucht, siehe [Budgetlaufbuch](CI_BUDGET_2026_09.md). **Keine Gesamtfreigabe:** ursprüngliche Motive/Übungsillustrationen, echte Health-/WeatherKit-/Netzwechsel-/Mail-/LIVE-Prüfung und FYRUP-Rechtslinks bleiben offen. Ältere Statusangaben unten sind historische Zwischenstände.

**Gebündelter Folgeblock (08.09.2026):** [Entdecken, Profil und SMTP](REFERENCE_DISCOVER_PROFILE_2026_09_08.md). Echte Bibliotheks-/Plansuche, Übungsdetails/Favoriten und geordnete Profilzugänge. [Stille Reconnect-Wege](TESTFLIGHT_CONNECTIVITY_AUDIT_2026-09-06.md) in #70 nativ mit simulierten Antworten geprüft; nicht auf dem installierten TestFlight-Build. Von den 23 neuen Unit-Tests bestanden 22, einziger Fehler siehe oben; alle drei neuen Referenz-Bedientests bestanden. SMTP über den freigegebenen Minaluneva-Absender produktiv gespeichert und bestätigt; tatsächliche Zustellung sowie iPhone-/TestFlight-, Health-/WeatherKit- und Netzwechselabnahme bleiben offen. Eigene veröffentlichte FYRUP-Rechtstexte fehlen weiterhin.

**Verbindliche Umfangsänderung vom 08.09.2026:** [Aktueller Release und spätere Version](RELEASE_SCOPE_2026_09_08.md). Lebensmittelsuche/-anbieter, Barcode, Rezepte und geräteübergreifende Ernährungssynchronisierung sind ausdrücklich **VERSCHOBEN**, nicht erledigt und keine aktuellen Release-Blocker. Google-Anmeldung ist **vollständig GESTRICHEN**. Apple/E-Mail, echter E-Mail-Versand und das vorhandene lokale manuelle Ernährungstagebuch samt Kalorienanzeigen bleiben im aktuellen Umfang. Diese Entscheidung geht älteren offenen Punkten und Bildreferenzen vor.

Neuer gebündelter Quellblock: [kompaktere Referenzlayouts und Wetter-Aktualisierung](REFERENCE_LAYOUT_WEATHER_2026_09_08.md). [QA #69](REFERENCE_QA_69.md) für exakt `e6eee6c`: **515/515 Unit-Tests, 8/9 Referenz-UI-Tests PASS**, Gesamtstatus FAIL wegen der AX-Link-Abfrage im Wettertest. Alle acht Wetter-Einzeltests bestanden; Stadt/Temperatur im Fixture-Bedientest erkannt. Vom Nutzer geliefertes Artefaktpaket vollständig protokolliert, **22 echte PNGs einzeln geprüft**. Dabei zusätzlich A01-Großschrift-Überbreite und R08-Kreistext-Überlauf gefunden; beide samt gezielten Assertions lokal korrigiert. A19-Kalorienänderung, Supplement-Menge und kompakte Summary nativ bestätigt. Der lokale Wochenplan-/Signierungsblock `953a0fd` sowie diese Folgekorrekturen sind **nicht** in #69 enthalten. Letzter lokaler Gesamt-Preflight **21/21 PASS**. Kein aktiver Build/Upload; 5,89 USD konservativ verbraucht, 4,11 USD unreserviert. Nachkontrolle des abgeschlossenen Laufs pausiert, keine automatische Wiederholung. Gesamte Referenz-/Geräteabnahme weiterhin offen.

Vorheriger Nachtrag vom 08.09.2026: [QA #68 auf `4679d89`](REFERENCE_QA_68.md) belegt **510/511 Unit-Tests und 5/7 Referenz-Bedientests PASS**, Gesamtstatus FAIL. Alle sieben E-Mail-Auth-Tests bestanden; drei eingegrenzte Testfehler für #69 korrigiert. 17 echte Simulatorbilder einzeln geprüft; Gestaltungsabweichungen bleiben offen. [Migrationen 017–019 produktiv angewendet und nachgeprüft](REFERENCE_BACKEND_2026_09_08.md), fehlenden Beleg 016 nach exaktem Vergleich ergänzt. Supabase-Rückkehradresse exakt `fyrup://auth-callback`. SMTP nur vorbereitet: freigegebener Kundenservice-Absender, aber noch keine verifizierten Ausgangsserver-Zugangsdaten. Separater FYRUP-Datenschutzentwurf nicht veröffentlicht. Echtes iPhone/TestFlight NICHT AUSGEFÜHRT. Kostenstand und aktiver Lauf siehe oben und [Budgetlaufbuch](CI_BUDGET_2026_09.md).

## Verbindlicher Folgeauftrag vom 08.09.2026

Die neue ausgewählte Registrierungscollage (18 Seiten) und Appcollage (8 Seiten) ersetzen ältere Designreferenzen, mit der oben genannten späteren Umfangsänderung. Aktuelle [Funktionsmatrix und Bestand](REFERENCE_IMPLEMENTATION_MATRIX.md), [Designspezifikation](DESIGN_2026_09_SPEC.md). Der aktuelle Auftrag umfasst WeatherKit und ein lokales manuelles Ernährungstagebuch; die weiteren Ernährungserweiterungen sind verschoben, Google entfällt. Ernährungskalorien auf Heute sind Aufnahme, keine aktive Energie. Körperdaten/Health sind optional; das Wochenziel beginnt bei 2 Einheiten. Historische Haken unten belegen keine Abnahme dieser neuen Anforderungen. Apple-Upload bis zur gebündelten Korrektur und Prüfung zurückgestellt.

**Aktueller Folgeblock:** [Einrichtung/Übersichten vom 08.09.](REFERENCE_LOCAL_SETUP_2026_09_08.md): benannte Wiederaufnahme, getrennte optionale Ziel-/Rechteseiten, editierbare Zusammenfassung. Nativer Stand nun #68, Backend 017–019 produktiv. Die vollständige neue Checkliste bleibt offen; ältere Nachweise unten sind historische Zwischenstände, keine Abnahme der aktuellen Vorlage.

Lokaler Folgeblock nach Commit `1ce784e`: Für reguläre Gym-Workouts ist in der Live-Aktivität ein datensparsamer Direkteinstieg „Satz eintragen“ ergänzt. Er öffnet nach Konto-/Sessionprüfung den ersten offenen Satz der aktuellen Übung für Gewicht, Wiederholungen und private Übungsbewertung; sensible Werte erscheinen nicht auf dem Sperrbildschirm. Automatische Feed-Aktualisierungen zeigen bei vorübergehendem Offline-/Serverzustand keinen globalen Hinweis mehr, behalten den aktuellen Stand und versuchen die Verbindung gestaffelt im Hintergrund erneut. Lokale Prüfungen, nativer Build, visuelle Live-Activity-Kontrolle und TestFlight-Abnahme sind noch getrennt nachzuweisen.

Neuester nativer Nachweis: [Codemagic 60](https://codemagic.io/app/6a9aff9f64377f6028cc8d18/build/6a9e689e3cf4759eab82a8cb) baute Commit `5d1b17a` vollständig und endete grün. **477 von 477 Einzeltests und 37 von 37 Bedienabläufen bestanden; `TEST SUCCEEDED`.** Damit ist zusätzlich der datensparsame Kontaktweg nativ geprüft: Der Nutzer wählt bei Kontakten mit mehreren Nummern ausdrücklich die gewünschte Nummer; leere Nummern werden abgelehnt. Der Bedienablauf öffnete außerdem die Kontakt-Einladungsseite und prüfte Auswahlaktion sowie Datenschutzhinweis. Der Lauf erzeugte Simulator-App und Prüfartefakte, aber keine signierte IPA. Die echte iPhone-Kontaktauswahl, SMS-Übergabe, registrierte Kontakte-Suche und TestFlight-Abnahme bleiben offen.

Vorheriger Support-Nachweis: [Codemagic 59](https://codemagic.io/app/6a9aff9f64377f6028cc8d18/build/6a9e539c3cf4759eab8271b5) baute Commit `f27cc7b` vollständig und endete grün. **475 von 475 Einzeltests und 37 von 37 Bedienabläufen bestanden; `TEST SUCCEEDED`.** Damit sind zusätzlich die echten Ziele „Freunde“, „Hilfe & Support“ und „Über FYRUP“, der Supportweg aus „Über FYRUP“, die sichtbare Adresse `Kundenservice@objektsignal.com`, das Kopieren der Adresse sowie der E-Mail-Ersatzhinweis nativ geprüft. Der Lauf erzeugte Simulator-App und Prüfartefakte, aber keine signierte IPA. Das Öffnen eines echten E-Mail-Programms, die visuelle Einzelbildkontrolle und die echte iPhone-/TestFlight-Abnahme bleiben offen.

Support-Folgelauf: [Codemagic 58](https://codemagic.io/app/6a9aff9f64377f6028cc8d18/build/6a9e4f583cf4759eab8267b2) stoppte nach 2 Minuten 33 Sekunden ausschließlich beim Übersetzen des erweiterten Bedienablaufs: `CriticalFlowsUITests` verwendete einen Helfernamen aus einer anderen Testklasse. App und Supportlogik waren nicht als fehlerhaft belegt; Tests wurden nicht ausgeführt. Der Folgequellstand verwendet den vorhandenen klasseninternen Helfer.

Aktueller Folgelauf: [Codemagic 56](https://codemagic.io/app/6a9aff9f64377f6028cc8d18/build/6a9e17d73cf4759eab81f351) prüfte Commit `a6a9e1b` vollständig: **475 von 475 Einzeltests und 37 von 37 Bedienabläufen bestanden; `TEST SUCCEEDED`.** Darin enthalten sind die tageswechsel-feste Session-Prüfung, die sofort aktualisierte Wochenübersicht, „SESSION ÖFFNEN“ für eigene geplante Sessions sowie der neue datensparsame Einstieg zum Einladen eines einzelnen iPhone-Kontakts. Die Erklärung zur Kontaktfreigabe ist im App-Bundle geprüft; echte Kontaktauswahl und SMS bleiben bis zur iPhone-Abnahme offen. Der einmalig gestartete [signierte TestFlight-Folgelauf](https://codemagic.io/app/6a9aff9f64377f6028cc8d18/build/6a9e22ff3765f0783f924c1d) ist für exakt denselben Commit vollständig grün: Die Release-Suite bestätigte erneut **475 Einzeltests ohne Fehler**, Signierung und Prüfung der eingebetteten Produktionskonfiguration bestanden, FYRUP `1.0.0` / Build `13` wurde als signierte IPA erzeugt und am 07.09.2026 um 05:20 CEST **ohne Uploadfehler** an App Store Connect übertragen. Apples anschließende Verarbeitung und die echte TestFlight-Abnahme auf dem iPhone bleiben getrennt offen. Migration 016 für den privaten Übungsverlauf ist produktiv angewendet und unabhängig geprüft: Funktion vorhanden, Ausführung für `authenticated` erlaubt sowie für `anon` und `public` gesperrt.

Siebter Prüflauf: `e317917` wurde in [Codemagic 45](https://codemagic.io/app/6a9aff9f64377f6028cc8d18/build/6a9cd7873cf4759eab7f4c28) vollständig gebaut. **459 von 459 Einzeltests und 33 von 33 Bedienabläufen bestanden; `TEST SUCCEEDED`.** Darin enthalten sind unter anderem die korrigierte Einrichtung mit verpflichtenden Körperdaten, Muskel-/Übungsfilter, Wochenrhythmus, „Deine Streak“, Supplemente, Health-Einrichtung, Satzpausen/Intervalle, Workout-Entwürfe, Satzdaten, Blind Workout und Call My Shot. Der einmalig gestartete [signierte TestFlight-Folgelauf 46](https://codemagic.io/app/6a9aff9f64377f6028cc8d18/build/6a9cdff81f365de10aeeec57) bestand dieselben **459 Einzeltests und 33 Bedienabläufe erneut ohne Fehler**, erzeugte die signierte IPA und lud FYRUP `1.0.0` / Build `11` am 06.09.2026 um 06:11 CEST ohne Uploadfehler zu Apple. Apple hat Build 11 verarbeitet; er ist der internen Gruppe „FYRUP Intern“ zugeordnet und „Bereit zur Übermittlung“. Die echte iPhone-Abnahme ist noch offen.

Frische lokale Backend-Gesamtprüfung am 06.09.2026: Alle elf vorhandenen Prüfprogramme endeten mit Exitcode 0. Sie decken die atomaren Migrationen 001–015, Onboarding, Einstellungen, Pläne/Katalog/Satzdaten, Schritte, Wochenziel und Deine Streak, Blind Workout, Call My Shot, Supplemente sowie Zugriffsschutz und Rücksetzpfade ab. Zusätzlich bestanden alle 57 Versand-/Sprachtests. Der Cloud-Ablauf führt ab dem nächsten gebündelten Stand nicht mehr nur drei, sondern alle elf Backend-Programme vor dem nativen Build aus. Der separate Katalogabgleich bestätigte 122 stabile Übungen und 127 geforderte Muskelzuordnungen. Diese isolierten PostgreSQL-Nachweise ersetzen weder den produktiven Supabase-Abgleich noch echte Parallelität, Pushzustellung oder iPhone-Tests.
...
- [x] Health-Energie bleibt exklusiv; ohne Health-Wert steht eine grobe, offen erklärte Schätzung aus Schritten oder freiwillig bewerteten abgeschlossenen Aktivitäten bereit. Sportart, aktive Dauer und persönliche Bewertung fließen ein; überlappende Quellen werden nicht addiert.
...
- [x] Im Ersteinstieg sind ein gültiges tägliches Schrittziel und eine bewusste Entscheidung für oder gegen Apple Health erforderlich; eine verweigerte Systemfreigabe blockiert die übrige App nicht und die getrennte Freigabe für Freunde bleibt standardmäßig aus.
- [x] Sieben feste Rechentests für Vorrang, Eingabegrenzen, Formel, Intensität/Doppelzählung, andere Sportarten und unzulässige beziehungsweise unbewertete Aktivitäten vorbereitet.
...
- [x] Die bisher wirkungslosen Einstellungszeilen „Freunde“, „Hilfe & Support“ und „Über FYRUP“ haben echte Ziele; Support bereitet eine Nachricht an `Kundenservice@objektsignal.com` vor und versendet nie automatisch. Der gemeinsame Bedienablauf bestand in Codemagic 55 und im signierten Build 13. Codemagic 59 bestätigte zusätzlich den Supportweg aus „Über FYRUP“, das Kopieren der Adresse und die klare Alternative, falls kein E-Mail-Programm verfügbar ist. Das Öffnen eines echten E-Mail-Programms und die TestFlight-Abnahme bleiben offen.
...
Fünfter Korrekturlauf: `20c52bc` wurde auf `main` geladen. [Codemagic 43](https://codemagic.io/app/6a9aff9f64377f6028cc8d18/build/6a9c8209fac9a246bedaa3e9) übersetzte App, Widget und beide Testziele; die zuvor fehlerhafte asynchrone Einzelprüfung kam durch. Der vollständige UI-Lauf führte 33 Abläufe aus, davon 27 erfolgreich und 6 fehlgeschlagen. Die vollständige Protokollauswertung grenzt sie auf drei gemeinsame Ursachen ein: eine Eltern-Kennung verdeckte die einzelnen Satzpausen-/Intervall-Schaltflächen, der Abschluss der persönlichen Einrichtung wechselte nicht ausdrücklich zur Abschlussseite und das vorausgefüllte Ortsfeld hatte keinen zuverlässigen Leeren-Weg. Diese drei Ursachen sind im lokalen Folgequellstand gebündelt korrigiert; ein erneuter nativer Lauf, visuelle Bilder und iPhone-Abnahme bleiben bis zum tatsächlichen Ergebnis offen.
...
**Neueste Arbeitsrunde ab 17:45 CEST:** Die Mängel der installierbaren Version sind als [verbindliche Modernisierungs-, Einrichtungs- und LIVE-Checkliste](MODERN_SETUP_LIVE_CHECKLIST.md) ergänzt und werden umgesetzt. Alle älteren offenen Anforderungen bleiben bestehen. Neue Änderungen sind noch nicht nativ abgenommen oder ausgeliefert. Apple hat den vorherigen **Build 10 / `5aa1f07` um 16:11 CEST erfolgreich als Upload angenommen**, aber die neue Runde ist darin nicht enthalten. GitHub 47: 26/27 UI-Abläufe bestanden; verbleibender Fehler bei kleiner Muskel-Fläche. Eine gruppierte, gezielt prüfbare Korrektur ist jetzt vorbereitet. **Codemagic-Build-Minuten aufgebraucht; keine kostenpflichtige Abrechnung aktiviert.** Ältere Laufstände darunter sind Historie.

Aktueller Stand 15:10 CEST: Beide Korrekturen sind zusammen als `5aa1f07` auf `main` hochgeladen. [GitHub 47](https://github.com/Momosn23/FYRUP/actions/runs/33967902685/job/101311146542) und [Simulator 37](https://codemagic.io/app/6a9aff9f64377f6028cc8d18/build/6a9c13aafac9a246bed9a3e3) laufen. Der neue native `testAppBundleIncludesBothHealthPurposeDescriptions` ist in GitHub 47 bestanden (0,001 s); vollständige Unit-/UI-Endergebnisse noch offen. [Signierter Folge-Build 10](https://codemagic.io/app/6a9aff9f64377f6028cc8d18/build/6a9c144faa8e5db63a97f4af) wurde mit `main` / `5aa1f07` angefordert und als queued bestätigt. Kein neuer TestFlight-Upload erfolgreich. Dieser Nachtrag bleibt vorerst lokal, um laufende Prüfungen nicht allein durch eine Dokumentaktualisierung neu zu starten.
...
- [ ] TRACK-01 Live-Kopf: Gym, Planname, LIVE, Dauer, aktuelle Übung und Fortschritt, z. B. 2/6; Social-Aktionen erreichbar. *(LIVE-Zustand, Planname, laufende aktive Zeit und Fortschritt sind in Build 13 nativ geprüft. Die erste noch offene Übung heißt in Build 57 eindeutig „Aktuelle Übung“ und der zugehörige Bedienablauf bestand; visuelle Einzelbild- und iPhone-Prüfung stehen aus.)*
...
- [x] RELEASE-02 Migrationen 001–015, RLS, Constraints, Wiederholung und Upgradepfade lokal vollständig geprüft; produktiver Verlauf und relevante RPC-Rechte separat kontrolliert.
- [x] RELEASE-03 Simulator-Build 45 und signierten Build 46 frisch bis zum Endstatus geprüft; beide 459/459 Einzeltests und 33/33 Bedienabläufe grün, Artefakte erzeugt.
- [x] RELEASE-04 Signierten Build für den eindeutigen Commit `e317917` als FYRUP 1.0.0 / Build 11 erstellt; spätere lokale Änderungen werden ausdrücklich nicht diesem Build zugerechnet.
...
- [x] RELEASE-06 Build 11 ist verarbeitet und „FYRUP Intern“ zugeordnet. Er enthält `e317917`; die danach lokalen Commits und aktuelle Kalorien-/CI-Erweiterung sind noch kein iPhone-Update.
