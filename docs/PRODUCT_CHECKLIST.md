...
**Aktueller nativer Prüfpunkt:** [QA #71 auf `b538d05`](REFERENCE_QA_71.md) **544/544 Unit-Tests und 12/12 Referenz-Bedientests PASS nach 13m11s**. Nutzer-ZIP am 09.09.2026 vollständig ausgewertet, alle 33 neuen Einzelbilder geprüft. Suche, Filterdarstellung und Montag-Woche im Profil bestätigt. Keine vollständige Design-/Geräteabnahme: ursprüngliche Motive/Übungsillustrationen, echte Health-/WeatherKit-/Netzwechsel-/Mail-/LIVE-Prüfung und FYRUP-Rechtslinks bleiben offen. Kein Apple-Upload durch #71; zuletzt bestätigt TestFlight 1.0.0 (15). Ein internes TestFlight-Prüfpaket mit unverändertem App-Code wird innerhalb des Restbudgets vorbereitet, Release-Limit vorher von 120 auf neun Minuten reduziert. Kein aktiver Build; konservativ 8,95 USD von 10 USD verbraucht, siehe [Budgetlaufbuch](CI_BUDGET_2026_09.md). Keine Gesamtfreigabe; ältere Statusangaben unten sind historische Zwischenstände.
