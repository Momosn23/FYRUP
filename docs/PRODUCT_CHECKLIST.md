...
**Aktueller nativer Prüfpunkt:** [QA #70 auf `704674e`](REFERENCE_QA_70.md) **FAIL nach 12m22s**. App kompiliert; Suchtest belegt einen falschen Rücken-Treffer bei „Bankdrücken“. Wortgrenzen-Korrektur und zwei weitere Tests lokal vorbereitet, ursprüngliche Assertion bleibt bestehen. Vollständige Testzahlen/Netzwerkfälle und neue Bilder warten auf das geschützte Artefaktpaket. Kein Folge-Build oder Apple-Upload; 7,36 USD konservativ verbraucht, 2,64 USD unreserviert im [Budgetlaufbuch](CI_BUDGET_2026_09.md). Keine Gesamtfreigabe; ältere Statusangaben unten sind historische Zwischenstände.

**Neuer gebündelter Folgeblock (08.09.2026):** [Entdecken, Profil und SMTP](REFERENCE_DISCOVER_PROFILE_2026_09_08.md). Echte Bibliotheks-/Plansuche, Übungsdetails/Favoriten und geordnete Profilzugänge im Code. Nach erneutem TestFlight-Hinweis [verbleibende Netzfehlerwege korrigiert](TESTFLIGHT_CONNECTIVITY_AUDIT_2026-09-06.md): stille Workout-Leseabfragen/Leistungsnachladen, Sitzung bei Startausfall behalten, WLAN-/Mobilfunkwechsel erkennen. Zusammen 23 neue Unit- und drei Referenz-Bedientests vorbereitet, noch nicht nativ ausgeführt. Eigener SMTP-Versand über den ausdrücklich freigegebenen Minaluneva-Absender produktiv gespeichert und frisch bestätigt; tatsächliche Mail-Zustellung bleibt offen. Kein zusätzlicher Build/Upload, keine Gesamtfreigabe.
