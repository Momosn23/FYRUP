...
Die neue ausgewählte Registrierungscollage (18 Seiten) und Appcollage (8 Seiten) ersetzen ältere Designreferenzen. Aktuelle [Funktionsmatrix und Bestand](REFERENCE_IMPLEMENTATION_MATRIX.md), [Designspezifikation](DESIGN_2026_09_SPEC.md). Der Auftrag erweitert den Umfang um Ernährung, WeatherKit und Google-Anmeldung. Ernährungskalorien auf Heute sind Aufnahme, keine aktive Energie. Körperdaten/Health sind optional; das Wochenziel beginnt bei 2 Einheiten. Historische Haken unten belegen keine Abnahme dieser neuen Anforderungen. Apple-Upload bis zur gebündelten Korrektur und Prüfung zurückgestellt.
